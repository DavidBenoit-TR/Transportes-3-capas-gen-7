...
namespace Transportes_3_capas_gen_7.Utilidades
{
    public class sweetAlert
    {
        public static void Swert_Alert(string title, string msg, string type, Page pg, Object obj)
        {
        ...
        public static void Swert_Alert(string title, string msg, string type, Page pg, Object obj, string dir)
        {
            string sa = "<script languaje='javascript'>" +
                "Swal.fire({" +
                "title: '" + title + "'," +
